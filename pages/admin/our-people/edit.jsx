...
const AdminOurPeopleEdit = ({ team }) => {
  ...
  const editMember = async (e) => {
    e.preventDefault();
    axios
      .put(`https://climate-nextjs-mysql.vercel.app/api/teams/${team.id}`, {
        name,
        jobname,
        image,
        facebook,
        ...
        <div className="container">
          ...
          <div className="page-content">
            <section className="add-new-member">
              <div className="row">
                <div className="col-12">
                  <form onSubmit={(e) => editMember(e)} style={{marginTop: '60px'}}>
                    <div className="row">
...
export async function getServerSideProps({ params, query }) {
  try {
    const teamRes = await axios.get(
      `https://climate-nextjs-mysql.vercel.app/api/teams/${query.id}`
    );
    return {
      props: {
        team: teamRes.data,
